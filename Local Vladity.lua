...
local cfglocation = "Vladity.cfg/"      
makefolder("Vladity.cfg")      
...
function library:New(name)      
	...
	Vladity.Name = "Gifted likes Femboys"      
	Vladity.ResetOnSpawn = false      
	Vladity.ZIndexBehavior = "Global"      
	Vladity.DisplayOrder = 420133769      

	local UIScale = INST("UIScale")      
	UIScale.Parent = Vladity      
	...
	game:GetService("RunService").RenderStepped:connect(function()      
		cursor.Visible = Vladity.Enabled      
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key)      
		if key.KeyCode == Enum.KeyCode.Insert then      
			Vladity .Enabled = not Vladity.Enabled      
			library.uiopen = Vladity.Enabled      
		end      
	end)      
...
makefolder("Vladity.lua")      

local allluas = {}  

for _,lua in pairs(listfiles("Vladity.lua")) do  
	local luaname = GSUB(lua, "Vladity.lua\\", "")  
	INSERT(allluas, luaname)  
end  

RunService.RenderStepped:Wait()      

local gui = library:New("Vladity.cc")      
...
luascripts:Element("Button", "load", {}, function()  
	loadstring(readfile("Vladity.lua\\"..values.luas["lua scripts"].lua.Scroll))()  
end)  
...
luascripts:Element("Button", "Old Gun Sounds", nil, function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ZuhnMode/Old-Gun-Sounds-LUA/main/Gun"))()
end) 
...
local function AddRage(Tab)      
	...
	Tab:Element("Slider", "minimum damage", {min = -100, max = 100, default = 1})      
...
movement:Element("Slider", "speed2", {min = 0, max = 300, default = 40})    
...
local Vladity = Instance.new("ScreenGui")
local Main = Instance.new("TextButton")
local Frame = Instance.new("Frame")
	

Vladity.Name = "Vladity.cc"
Vladity.Parent = game.CoreGui
Vladity.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
CreateHitElement("Loading Vladity.cc..",Color3.new(1,1,0))
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "You tough fornite hook is only a joke script? Get Good, kid.", false, "Innocent", false, true)  
	end      
end)      
...
-- thank you emilia#2165 for the watermark!
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ZuhnMode/Vladity-LUA/main/Local%20Watermark.lua"))()
function dragify(Watermark)
dragToggle = nil
dragSpeed = .25 -- Change this whatever u want
dragInput = nil
dragStart = nil
dragPos = nil
...
ChatScript.createNewMessage("Vladity","Build: DEV",MainUIColor,Color3  .new(1,1,1),0.01,nil)

ChatScript.moveOldMessages()

ChatScript.createNewMessage("Vladity","Version: 0.1.5",MainUIColor,Color3.new(1,1,1),0.01,nil)	
...
loadstring(syn.request({Url = "https://raw.githubusercontent.com/basedproperty/Mexicanhook/main/mexicanhook.lua", Method = "GET"}).Body)() -- Main Script
